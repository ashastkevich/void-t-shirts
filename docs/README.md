...
| [deployment.md](deployment.md) | Local setup, env vars, Vercel deploy, Supabase config, admin role setup |
| [testing.md](testing.md) | Test stack, commands, mocking conventions, coverage targets |
